...
const handlePizzaSubmit = (event) => {
  ...
  /*POST the formData object to the API. We've simply added an alert() if it's successfully created, as we don't know what Pizza Hunt has in store for this functionality yet. */
  fetch("/api/pizzas", {
    method: "POST",
    headers: {
