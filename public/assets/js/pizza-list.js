...
/**this function will get all of our pizza data, transform it into JSON data that we can use, and run each one through the printPizza function using the .forEach() method.  */
const getPizzaList = () => {
  fetch("/api/pizzas")
...
//passing the json pizza data to the print pizza function
const printPizza = ({
  _id,
  pizzaName,
  toppings,
...
// calling the function to fetch the pizza data
getPizzaList();
