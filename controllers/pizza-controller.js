...
const pizzaController = {
    /*get all pizzas method is the callback function for the get/appi/pizzas route. It uses mongoose .find() method as a catch all much like the .findAll method in sequelize*/
    getAllPizza(req, res)   {
        Pizza.find({})
    ...
    //get one pizza by id uses mongoose .findOne() method to  find a single pizza by its _id
